...
import 'package:aplicacao_cliente_hibrida/page/dashboard/layouts/components/widgets/energy_consumption_display.dart';
import 'package:aplicacao_cliente_hibrida/page/dashboard/layouts/components/widgets/kwh_meter_display.dart';
...
class CardKwh extends StatefulWidget {
  final String topic;
  final IoTDevice ioTDevice;
  const CardKwh({super.key, required this.topic, required this.ioTDevice});

  @override
  State<CardKwh> createState() => _CardLedState();
}

class _CardLedState extends State<CardKwh> {
  late KwhStore store;
                ...
                return Column(
                  ...
                  children: <Widget>[
                    Padding(
                      ...
                      child: Text(
                        AppLocalizations.of(context)!.kWh,
                        style: TextStyle(
                          color: Colors.white,
