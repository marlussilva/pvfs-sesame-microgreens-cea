...
part 'futuristic_humidity_sensor_store.g.dart';

class FuturisticHumiditySensorStore = _FuturisticHumiditySensorStoreBase
    with _$FuturisticHumiditySensorStore;

abstract class _FuturisticHumiditySensorStoreBase with Store {
  ...
  Future<void> connectMqtt() async {
    ...
    mqttStore = MqttStore(MyConfig.IP, "${randomNumber}client_humidity");
