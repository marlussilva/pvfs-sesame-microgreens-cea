...
part 'morden_thermometer_store.g.dart';

class MordenThermometerStore = _MordenThermometerStoreBase
    with _$MordenThermometerStore;

abstract class _MordenThermometerStoreBase with Store {
   @observable
  ...
  Future<void> connectMqtt() async {
    ...
    mqttStore = MqttStore(MyConfig.IP, "${randomNumber}client_temperature");
