...
part 'intesity_display_store.g.dart';

class IntesityDisplayStore = _IntesityDisplayStoreBase
    with _$IntesityDisplayStore;

abstract class _IntesityDisplayStoreBase with Store {
  @observable
