...
part 'power_factor_store.g.dart';

class PowerFactorStore = _PowerFactorStoreBase with _$PowerFactorStore;

abstract class _PowerFactorStoreBase with Store {
  @observable
  ...
  Future<void> connectMqtt() async {
    ...
    mqttStore = MqttStore(MyConfig.IP, "${randomNumber}power_factor");
