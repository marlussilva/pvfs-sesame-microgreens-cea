...
part 'wifi_display_store.g.dart';

class WifiDisplayStore = _WifiDisplayStoreBase with _$WifiDisplayStore;

abstract class _WifiDisplayStoreBase with Store {
  @observable
  ...
  Future<void> connectMqtt() async {
    ...
    mqttStore = MqttStore(MyConfig.IP, "${randomNumber}client_rssi");
