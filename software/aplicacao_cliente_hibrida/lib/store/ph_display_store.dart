...
part 'ph_display_store.g.dart';

class PhDiplayStore = _PhDiplayStoreBase with _$PhDiplayStore;

abstract class _PhDiplayStoreBase with Store {
  @observable
  ...
  Future<void> connectMqtt() async {
    ...
    mqttStore = MqttStore(MyConfig.IP, "${randomNumber}client_ph");
