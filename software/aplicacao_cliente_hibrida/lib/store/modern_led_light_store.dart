...
part 'modern_led_light_store.g.dart';

class ModernLedLightStore = _ModernLedLightStoreBase with _$ModernLedLightStore;

abstract class _ModernLedLightStoreBase with Store {
  @observable
  ...
  Future<void> connectMqtt() async {
    ...
    mqttStore = MqttStore(MyConfig.IP, "${randomNumber}client_led");
