...
part 'co2_sensor_display_store.g.dart';

class Co2SensorDisplayStore = _Co2SensorDisplayStoreBase
    with _$Co2SensorDisplayStore;

abstract class _Co2SensorDisplayStoreBase with Store {
  @observable
  ...
  Future<void> connectMqtt() async {
    ...
    mqttStore = MqttStore(MyConfig.IP, "${randomNumber}client_co2");
